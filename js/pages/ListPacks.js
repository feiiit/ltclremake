                ...
                <table class="list" v-if="selectedPackLevels">
                    <tr v-for="(level, i) in selectedPackLevels">
                        ...
                        <td class="level" :class="{ 'active': selectedLevel == i, 'error': !level[0] }">
                            <button :style= "[selectedLevel == i ? {background: white, color: getFontColour(pack.colour)}]" @click="selectedLevel = i">
            ...
            <div class="level-container">
                <div class="level" v-if="selectedPackLevels[selectedLevel][0]">
                    ...
                    <div style="display:flex">
                        <div v-for="pack in selectedPackLevels[selectedLevel][0].level.packs" class="tag" :style="{background:pack.colour, getFontColour(pack.colour)}">{{pack.name}}</div>
                    </div>
